...
namespace Buckey {
    ...
    ASRServiceAdapter::ASRServiceAdapter(ASRService * adaptee, std::string path) : ServiceAdapter(adaptee, path) {
        ...
        temp_method = this->create_method<void,uint8_t>("ca.l5.expandingdev.Buckey.ASR", "setListeningBehavior",sigc::mem_fun( adaptee, &ASRService::_setListeningBehavior));
        ...
        temp_method = this->create_method<void,uint8_t>( "ca.l5.expandingdev.Buckey.ASR", "setRecognitionMode",sigc::mem_fun( adaptee, &ASRService::_setRecognitionMode ) );
